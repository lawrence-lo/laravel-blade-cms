...
<section class="w3-padding">
    ...
    <form method="post" action="/console/certifications/add" novalidate class="w3-margin-bottom">
        ...
        <button type="submit" class="w3-button w3-green">Add Certification</button>
